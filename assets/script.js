...
// 	// let request = `https://public-api.tracker.gg/v2/apex/standard/profile/${userPlat}/${userName}`;
// 	// console.log(request);
...
// 	// })
// 	// .then(data => {
// 	// 	console.log(`Kills: ${data.segments[0].kills.value}\nDamage: ${data.segments[0].damage.value}`);
// 	// })
// 	// .catch(err => {
// 	// 	console.error(err);
// 	// });
...
// tracker.gg key: da25f33c-7469-4fcb-aba3-db4dc3556c06
...
function userQueryPopulate(userName, fgp) {
	...
	// cardToSelect = "#second-card";

	// switch (sgpArr[0]) {
	// 	case "COD":
	// 		console.log(userName, sgpArr[1], cardToSelect);
	// 		renderCOD(userName, sgpArr[1], cardToSelect);
	// 		break;
	// 	case "APEX":
	// 		console.log(userName, sgpArr[1], cardToSelect);
	// 		renderAPEX(userName, sgpArr[1], cardToSelect);
	// 		break;
	// 	default:
	// 		alert("Could not find that game.");
	// }
